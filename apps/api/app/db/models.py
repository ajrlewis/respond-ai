...
class RFPSession(Base):
    ...
    retrieval_strategy_used: Mapped[str | None] = mapped_column(String(32), nullable=True)
    ...
    retrieval_plan_payload: Mapped[dict] = mapped_column(JSONB, default=dict)
    retrieval_metadata_payload: Mapped[dict] = mapped_column(JSONB, default=dict)
    evidence_evaluation_payload: Mapped[dict] = mapped_column(JSONB, default=dict)
    evidence_payload: Mapped[list[dict]] = mapped_column(JSONB, default=list)
    selected_evidence_payload: Mapped[list[dict]] = mapped_column(JSONB, default=list)
    rejected_evidence_payload: Mapped[list[dict]] = mapped_column(JSONB, default=list)
