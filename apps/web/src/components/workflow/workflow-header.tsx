...
export function WorkflowHeader({ currentUsername, isLoggingOut = false, onLogout }: WorkflowHeaderProps) {
  return (
      ...
      <div className="header-top-row">
        ...
        {onLogout ? (
          <div className="header-actions">
            <span className="user-chip">{currentUsername ?? "admin"}</span>
            <button type="button" className="secondary" onClick={onLogout} disabled={isLoggingOut}>
